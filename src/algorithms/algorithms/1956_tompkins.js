...
function tompkinsWrapper(inputArray, rotationDirection) {
  function tompkinsPermutations(n, inputArray, rotationDirection, cb) {
    ...
    while (c <= n) {
      ...
      inputArray = rotate(inputArray.slice(0, n), rotationDirection).concat(
        inputArray.slice(n)
      );
      if (c >= n) {
        break;
...
module.exports = {
  ...
  arguments: 2,
  info: `This is a recurive implementation of Tompkins and Paige's 1956 permutation algorithm As described in Robert Sedgewick's 1977 "Permutation Generation Methods" paper`,
